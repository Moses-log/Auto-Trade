...
async def test_notify_trade_broadcasts_signal_on_immediate_fill():
    ...
    mock_signal.assert_called_once_with("SPY", "BUY", dollar_pnl=None, pct_pnl=None, filled_price=537.42)
...
async def test_notify_pending_order_fill_broadcasts_signal_after_fill():
    ...
    mock_signal.assert_called_once_with("SPY", "BUY", dollar_pnl=None, pct_pnl=None, filled_price=551.80)
